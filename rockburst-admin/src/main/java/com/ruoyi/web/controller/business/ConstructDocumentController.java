...
public class ConstructDocumentController {
    ...
    @PostMapping("/addFile")
    public R<Object> addFile(@ApiParam(name = "file", value = "文件", required = true) @RequestPart MultipartFile file,
    ...
    public R<Object> updateFile(@ApiParam(name = "file", value = "文件", required = true) @RequestPart MultipartFile file,
                                @RequestParam(value = "bucketName", required = false) String bucketName,
