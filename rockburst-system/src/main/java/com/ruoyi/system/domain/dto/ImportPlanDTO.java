...
public class ImportPlanDTO implements Serializable {
    ...
    @Excel(name = "巷道名称(必填)", sort = 9, width = 20)
    private String tunnelName;

    @ApiModelProperty(value = "起始导线点")
    @NotBlank(message = "起始导线点不能为空")
    @Excel(name = "起始导线点(必填,符号为英文符号)", sort = 10, width = 20)
    ...
    @Excel(name = "终始导线点(必填,符号为英文符号)", sort = 12, width = 20)
    ...
    @Excel(name = "钻孔类型(必填)", sort = 14, width = 20)
    private String drillType;

    @ApiModelProperty(value = "计划开始时间")
    @NotBlank(message = "计划开始时间不能为空")
    @Excel(name = "计划开始时间(必填,格式yyyy-MM-dd)", dateFormat = "yyyy-MM-dd", sort = 15, width = 20)
    private String startTime;

    @ApiModelProperty(value = "计划结束时间")
    @NotBlank(message = "计划结束时间不能为空")
    @Excel(name = "计划结束时间(必填,格式yyyy-MM-dd)", dateFormat = "yyyy-MM-dd", sort = 16, width = 20)
