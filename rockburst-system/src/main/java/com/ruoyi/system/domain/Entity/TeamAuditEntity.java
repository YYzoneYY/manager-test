...
public class TeamAuditEntity extends BusinessBaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "区队审核id")
    @TableId(value = "team_audit_id", type = IdType.AUTO)
    ...
    @ApiModelProperty(value = "科室审核结果")
    @TableField("depart_audit_state")
    private String departAuditState;
