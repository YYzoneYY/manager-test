...
public interface MultiplePlanService extends IService<MultiplePlanEntity> {
    ...
    boolean saveBatch(String warnInstanceNum, List<MultipleParamPlanDTO> multipleParamPlanDTOs, Long mineId);

    boolean updateBatchById(String warnInstanceNum, List<MultipleParamPlanDTO> multipleParamPlanDTOS, Long mineId);
