...
public class NewFileUploadUtils {
            ...
            InvalidExtensionException
    {
        ...
        {
            throw new FileNameLengthLimitExceededException(NewFileUploadUtils.DEFAULT_FILE_NAME_LENGTH);
        }
    ...
    public static final String extractFilenameTemplate(MultipartFile file){
        return StringUtils.format("{}/{}.{}", "Import_Template",
